            ...
            children: [
              GoogleMap(
                ...
                onCameraMove: (CameraPosition position) {
                  editController.latLng = position.target;

                  // controller.changeMarker(LatLng(
                  //     position.target.latitude, position.target.longitude));
                },
                onMapCreated: (GoogleMapController controller) {
                  if (!editController.controller.isCompleted) {
                    editController.controller.complete(controller);
                    editController.controllerGoogleMap = controller;
                  } else {
                    editController.controllerGoogleMap = controller;
                  }
                },
              ...
              Positioned(
                ...
                child: InkWell(
                  onTap: () {
                    editController.getCurrentLocation();
                  },
                  child: Container(
              ...
              Positioned(
                ...
                right: 30,
                child: InkWell(
                  onTap: () => editController.selectLocation(),
                  child: Container(
              ...
              Positioned(
                  ...
                  child: SearchMapPlaceWidget(
                    ...
                    onSelected: (Place place) async {
                      ...
                      editController.getLocationFromSearch(geolocation);
                    },
